  ...
  return (
    <div id="about-us-page-view" className="w-full max-w-7xl mx-auto px-4 py-8 md:py-16">
      ...
      <div className="max-w-3xl mx-auto text-center mb-16" id="about-header-block">
        <span className="text-xs font-bold font-mono uppercase tracking-widest text-amber-500 bg-amber-500/10 px-3.5 py-1.5 rounded-full">
          Who We Are
        </span>
        ...
        <div className="mt-8 p-6 bg-neutral-900/40 border border-neutral-800 rounded-2xl text-neutral-300 text-sm md:text-base leading-relaxed text-left">
      ...
      <div className="text-center mb-10">
        <h3 className="font-display font-medium text-base text-neutral-400 tracking-wider uppercase mb-6">Current Governing Board Profiles</h3>
      </div>
      ...
      {boardMembers.length === 0 ? (
        <div className="text-center p-12 bg-neutral-900/10 border border-dashed border-neutral-800 rounded-xl max-w-md mx-auto">
          ...
          <p className="text-base text-neutral-400 font-medium">No board members configured in the index.</p>
          <p className="text-sm text-neutral-500 mt-1">President and Secretary can add board profiles via the Admin Panel!</p>
        </div>
      ) : (
          ...
          {boardMembers.map((member, mIdx) => (
            ...
            >
              <div>
                ...
                <div className="relative aspect-square w-full bg-neutral-900 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 flex flex-wrap gap-1">
                    <span className="text-xs font-bold font-mono uppercase bg-amber-500 text-neutral-950 px-2.5 py-1 rounded-full shadow-md">
                ...
                <div className="p-6 text-left">
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2.5 mb-4">
                    {member.roles.map((role, rIdx) => (
                      <span 
                        key={rIdx} 
                        className="text-xs font-semibold font-mono uppercase bg-neutral-900 border border-neutral-800 text-neutral-300 px-2.5 py-1 rounded"
                      >
                        {role}
                      </span>
                    ))}
                  ...
                  <p className="text-sm text-neutral-405 text-neutral-400 leading-relaxed font-sans mb-4">
                    {member.bio}
                  </p>
                </div>
              </div>
              ...
              {member.specialAchievement && (
                <div className="px-6 py-4 bg-neutral-900/40 border-t border-neutral-900/60 flex items-center space-x-2 text-sm">
      ...
      <div className="mt-20 border-t border-neutral-900 pt-12 text-center" id="ethics-block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto text-left mt-8">
          <div className="p-5 bg-neutral-900/20 border border-neutral-900 rounded-xl">
            ...
            <p className="text-xs text-neutral-400 mt-2">Documenting reality faithfully, preserving the natural mood and composition.</p>
          </div>
          <div className="p-5 bg-neutral-900/20 border border-neutral-900 rounded-xl">
            <h5 className="font-bold text-amber-500 text-sm">Empathetic Exposure</h5>
            <p className="text-xs text-neutral-400 mt-2">Approaching subjects with human dignity and mutual respect at all times.</p>
          </div>
          <div className="p-5 bg-neutral-900/20 border border-neutral-900 rounded-xl">
            <h5 className="font-bold text-amber-500 text-sm">Continuous Masterclass</h5>
            <p className="text-xs text-neutral-400 mt-2">Fostering active peer mentorship in shooting, lighting, and workflow.</p>
          </div>
        </div>
      </div>
