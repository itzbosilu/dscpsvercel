          ...
          {activeSubTab === 'branding' && (
            <div id="subtab-branding-workspace" className="animate-fade-in text-left">
              ...
              <form onSubmit={handleSaveBranding} className="space-y-6 font-sans text-xs text-neutral-300">
                ...
                <div>
                  <label className="block text-[10px] uppercase font-mono tracking-wider text-neutral-400 mb-1.5">Lading Hero Backdrop Image URL</label>
                  <input
                    type="url"
                    required
                    value={heroImageInput}
                    onChange={e => setHeroImageInput(e.target.value)}
                    className="w-full bg-neutral-900 border border-neutral-800 rounded-lg p-2.5 text-xs text-white focus:outline-none font-mono"
                  />
                </div>
            ...
            <div id="subtab-board-workspace" className="animate-fade-in text-left">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                ...
                <form onSubmit={handleCreateOrUpdateBoard} className="md:col-span-5 bg-slate-900/30 border border-slate-900 p-4 rounded-2xl space-y-4">
                  ...
                  <div>
                    <label className="block text-[10px] uppercase font-mono text-slate-400 mb-1">Board Portrait URL</label>
                    <input
                      type="url"
