      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 cursor-pointer" onClick={() => handleNav('home')}>
          ...
          <div className="hidden md:block">
            ...
            <p className="text-[10px] text-neutral-400 font-mono tracking-widest">{siteConfig.domain}</p>
          </div>
        </div>
                  ...
                  <div className="px-4 py-3 border-b border-neutral-900">
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {currentUser.roles.map((role, rIdx) => (
                        <span 
                          key={rIdx} 
                          className={`text-[9px] px-1.5 py-0.5 rounded font-bold font-mono uppercase tracking-wider ${
